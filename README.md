...
**Python:** Customer API, Admin API, Discovery API, and Customer BFF require **Python 3.11 or newer** (3.13 recommended). Each Python app has a `.python-version` file (3.13); use that version locally if available, or 3.11.

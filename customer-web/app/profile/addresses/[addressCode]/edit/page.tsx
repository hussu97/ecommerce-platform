...
export default function EditAddressPage() {
  ...
  const addressCode = params.addressCode as string;
  ...
  useEffect(() => {
    if (!isAuthenticated) {
      router.push(`/login?redirect=/profile/addresses/${addressCode}/edit`);
      return;
    }
    ...
    (async () => {
      try {
        ...
        setForm({
          ...
          phone: a.phone,
          address_type: a.address_type as "home" | "office" | "other",
          lat: a.lat ?? null,
          lng: a.lng ?? null,
          street: a.street,
          city: a.city,

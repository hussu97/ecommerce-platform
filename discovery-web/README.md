...
For production or when the API is on another host, set `VITE_DISCOVERY_API_URL` to the full discovery-api base URL (e.g. `https://discovery-api.example.com`) at **build time**.

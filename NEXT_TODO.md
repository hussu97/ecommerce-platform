...
| Status | Task | Description | Effort |
|--------|------|-------------|--------|
| ✅ | **API Gateway / BFF** | Optional API gateway or BFF layer for auth, aggregation, rate limiting. *Done:* customer-bff (proxy, rate limit, GET /v1/checkout-context), Docker port 8012. | High |
| ✅ | **Structured Logging & Tracing** | Request IDs across services; optional OpenTelemetry for traces. *Done:* request_id in structlog context; OTel in customer-api and admin-api (trace_id/span_id in logs, OTLP export); BFF forwards X-Request-ID. | Medium |
...
*Last updated: 2025-02-09 (BFF + tracing)*
